...
export default function Mint() {
    ...
    return (
        ...
        {/*<p className="text-sm text-pink-200 tracking-widest mt-3">Max Mint Amount: {maxMintAmount} </p> */}
                        ...
                        Matic
                            ...
                            {walletAddress ? (
                                <button 
                                className={` ${paused || isMinting ? 'bg-gray-900 cursor-not-allowed' : 'bg-gradient-to-br from-brand-purple to-brand-pink shadow-lg hover:shadow-pink-400/50'} font-coiny mt-12 w-full px-6 py-3 rounded-md text-2xl text-white  mx-4 tracking-wide uppercase`}
                            ...
                            <div className="border-t border-gray-800 flex flex-col items-center mt-10 py-2 w-full">
                                ...
                                <a href={`https://polygonscan.com/address/${config.contractAddress}#readContract`}
